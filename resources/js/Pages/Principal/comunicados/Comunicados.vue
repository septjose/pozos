            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <i class="ph-megaphone fs-1 me-2"></i> <!-- Agrega un margen a la derecha -->
                        <h4 class="mb-0 text-muted fw-bold">Comunicados</h4> <!-- Quita el margen inferior -->
                    </div>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center g-2">
                            <div class="col-lg-3 me-auto">
                                <h6 class="card-title mb-0"><i>Lista de comunicados</i></h6>
                            </div><!--end col-->
                            ...
                            <div class="col-md-auto">
                                <div class="hstack gap-2">
                                    <a href="/crear_comunicados" type="button" class="btn btn-success add-btn" ><i class="bi bi-plus-circle align-baseline me-1"></i> Agregar</a>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </div>
                        ...
                        <div class="table-responsive table-card">
                            <table class="table table-centered align-middle table-custom-effect table-nowrap mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort cursor-pointer" data-sort="customer_name">Fecha del comunicado</th>
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted mb-0"> No encontramos ningún comunicado.</p>
                                </div>
                            </div>
                        </div>
...
<div class="modal-body">
    <div class="mt-2 text-center">
        ...
        <div class="mt-4 pt-2 fs-base mx-4 mx-sm-5">
            <h4>Eliminar el comunicado</h4>
            <p class="text-muted mx-4 mb-0">Esta seguro de eliminar el comunicado?</p>
        </div>
    </div>
